...
BATCH_TARGETS = {
    "hedge_witch": {"common": 4, "uncommon": 4, "rare": 3},
    "mortuary_apprentice": {"common": 4, "uncommon": 4, "rare": 4},
    "night_watch_recruit": {"common": 4, "uncommon": 4, "rare": 4},
}
...
def test_act_2_class_relics_batch_2_counts_match_targets() -> None:
...
def test_act_2_class_relics_batch_2_are_class_specific_and_supported() -> None:
    catalog = load_content_catalog_from_act_manifest("data/acts/act_2_archives.json")
