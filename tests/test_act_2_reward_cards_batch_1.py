...
TARGETS = {
    "bureaucrat": {"common": 10, "uncommon": 10, "rare": 5},
    "failed_wizard": {"common": 7, "uncommon": 8, "rare": 4},
    "guild_assassin_apprentice": {"common": 8, "uncommon": 6, "rare": 4},
}
...
def test_batch_1_classes_match_act_1_reward_counts_and_rarities() -> None:
...
def test_batch_1_cards_are_in_rewards_and_shop_but_not_epic() -> None:
    catalog = load_content_catalog_from_act_manifest("data/acts/act_2_archives.json")
