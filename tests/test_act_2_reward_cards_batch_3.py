...
TARGETS = {
    "sewer_diplomat": {"common": 8, "uncommon": 7, "rare": 4},
    "shroomancer": {"common": 9, "uncommon": 7, "rare": 2},
    "witch_clerk": {"common": 10, "uncommon": 7, "rare": 3},
}
...
def test_batch_3_classes_match_act_1_reward_counts_and_rarities() -> None:
...
def test_batch_3_cards_are_in_rewards_and_shop_but_not_epic() -> None:
    catalog = load_content_catalog_from_act_manifest("data/acts/act_2_archives.json")
